                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="password" type="password" name="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }} form-control-lg" placeholder="Password" required="">
                    ...
                    <div class="row m-t-20">
                        ...
                        <form class="col-12" method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }} form-control-lg" name="email" value="{{ old('email') }}" required placeholder="Email Address">
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('email') }}</strong>
                                    </span>
